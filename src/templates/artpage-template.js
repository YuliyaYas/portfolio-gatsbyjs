        ...
        return info[column].map((art, i)=>{
            ...
            return <div key={i}>
                        <div className="column-grid">
                         ...
                         <div className="mobile-info"><p className="all-caps">{art.title}</p>{ specs ? <i><p className="title">{specs}</p></i> : "" }{description ? <p className="desc">{description}</p> : "" }<hr /></div></div>
                    </div>
        })
    })
